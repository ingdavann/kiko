            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-12 gap-8 py-14 lg:grid-cols-8">
                    ...
                    <div className="w-full text-center lg:w-auto lg:text-left col-span-full sm:col-span-4 md:col-span-4 lg:col-span-2 ">
                        ...
                        <ul className="text-gray-600  transition-all duration-500">
                            <li className="mb-3">kiko@commerce@gmail.com</li>
                            <li className="mb-3">+855 10 xxx xxxx</li>
                            <li >61-A, vann street, Phnom Penh, Cambodia.</li>
                        </ul>
                    </div>
                    {/* <!--Product--> */}
                        ...
                        <div className="text-gray-600 transition-all duration-500">
                            
                            {
                                menu.map((item, index) => (
                                    ...
                                    <Link  onClick={()=>updateMenu(item.path)} href={item.path} className="text-gray-600">
                                        {item.name}
                                    </Link>
                                    </div>
                                ))
                    ...
                    <div className="w-full text-center lg:w-auto lg:text-left col-span-full sm:col-span-4 md:col-span-4 lg:col-span-2 ">
                        ...
                        <div className="flex flex-col items-center lg:items-start">
                            <input type="text" className="w-full h-12 border border-gray-300 rounded-full py-2.5 px-5 shadow-sm mb-5 text-center lg:text-left placeholder:text-gray-400 focus:outline-none focus:border-gray-500" placeholder="Your email here.." />
                ...
                <div className="py-7 border-t border-gray-200">
                    <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                        <span className="text-sm text-gray-500 ">©<a href="#">KIKO</a> 2024, All rights reserved.</span>
